...
parser.add_argument("--samples_per_epoch", type=int, default=11520, 
                    help="how many total samples for an epoch, a large composite")
...
args.epoch_steps = args.samples_per_epoch // args.real_bsz
assert args.epoch_steps * args.real_bsz == args.samples_per_epoch
...
# 初始化 LightningModule
lightning_module = HFLM(model, args, dataset)
...
trainer = pl.Trainer(
    ...
    # callbacks=[callbacker, checkpointer],
